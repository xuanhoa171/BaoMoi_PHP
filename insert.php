...
<body>
    <div class="wrapper">
        ...
        <!-- content start -->
        <div class="content">
            <form action="" method="POST" class="insert-news">
                <p class="insert-des">Tải ảnh bài viết</p>
                <input class="input-insert" type="text" placeholder="Hình ảnh" name="newsImage">
                <p class="insert-des">Tải ảnh tòa soạn</p>
                <input class="input-insert" type="text" placeholder="Hình ảnh" name="officeImage">
                <p class="insert-des">Tiêu đề bài viết</p>
                <input class="input-insert" type="text" name="title" id="" placeholder="Tiêu đề"></br>
        ...
        if ($conn->connect_error) {
            ...
            if(isset($_SESSION['userID'])){
                if (isset($_POST['insertBtn'])) {
                    ...
                    $officeImage = $_POST['officeImage'];
                    $title = $_POST['title'];
                    $sql = "INSERT INTO news(img, tittle, userUploadID, newOfficeImg) VALUES ('$newsImage','$title','$userID','$officeImage')";
                    $result = $conn->query($sql);
                    if ($result == true) {
                        echo "<div class='center-div'>
                                    <div class='login-noti'>
                                        <p class='noti-des'>Thêm thành công</p>
                                    </div>
                                </div>";
                    } else {
                        echo "<div class='center-div'>
                                    <div class='login-noti'>
                                        <p class='noti-des'>Thêm thất bại</p>
                                    </div>
                                </div>";
                    }
                }
